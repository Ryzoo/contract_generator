        ...
        >
            <v-card>
                ...
                <v-card-text>
                    ...
                    <v-alert v-else dense text class="my-5" type="info">
                ...
                <v-card-actions>
                    ...
                    <v-btn
                        ...
                        >{{ $t('base.button.close') }}</v-btn
                    >
                    <v-btn color="primary" @click="hideNotifications">{{
                        $t('base.button.makeAsRead')
                    }}</v-btn>
                </v-card-actions>
            </v-card>
        </v-dialog>
...
export default {
    ...
    methods: {
        hideNotifications() {
            this.Notification.setAsRead().then(() => {
        ...
        calculateAccessArray(elements) {
            return elements
                .map((x) => {
                    ...
                    if (x.access) {
                        x.active = x.access.every((z) =>
                            this.Auth.checkPermission(z)
                        )
                    }
