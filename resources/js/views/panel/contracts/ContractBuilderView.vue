<template>
  <v-row v-if="isLoaded">
    ...
    <v-col cols="12">
      <BlockLayout @show-block-modal="showBlockModal = true" />
    </v-col>

    <v-dialog v-model="showBlockModal" scrollable max-width="800px">
      <SelectedBlockView @close="showBlockModal = false" />
    </v-dialog>

    <v-dialog v-model="showAttributeModal" scrollable width="900px">
