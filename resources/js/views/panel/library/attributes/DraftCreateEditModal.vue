    ...
    data() {
        return {
            ...
            form: {
                ...
                rules: {
                    name: [
                        ...
                        (v) =>
                            v.length >= 3 ||
                            'Name must be grater than 10 characters',
                    ],
                    description: [
                        (v) => !!v || 'Description is required',
                        (v) =>
                            v.length >= 3 ||
                            'Description must be grater than 3 characters',
                    ],
            ...
            isNew:
                ...
                this.editAttributeId === undefined,
        }
    },
    watch: {
        editAttributeId() {
    ...
    methods: {
        ...
        saveDraft() {
            ...
            axios
                ...
                .then(() => {
                    this.$store.dispatch(
                        'library_attributes_updateDraft',
                        this.draft
                    )
                    this.closeDialog()
                })
