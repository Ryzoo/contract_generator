  ...
  computed: {
    attributesToAggregate() {
      return this.attributes
        .filter(
          (x) =>
            parseInt(x.attributeType) === AttributeTypeEnum.NUMBER ||
            parseInt(x.attributeType) === AttributeTypeEnum.ATTRIBUTE_GROUP ||
            parseInt(x.attributeType) === AttributeTypeEnum.BOOL_INPUT
        )
        .map((x) => ({
