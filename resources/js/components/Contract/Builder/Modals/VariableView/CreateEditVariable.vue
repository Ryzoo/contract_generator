                ...
                <v-col cols="12">
                    <v-expansion-panels>
                        <v-expansion-panel>
                            <v-expansion-panel-header
                                >Additional
                                configuration</v-expansion-panel-header
                            >
                            <v-expansion-panel-content>
                                <v-row>
                                    <v-col cols="12">
                                    ...
                                    <v-col cols="12">
                                        <v-text-field
                                            ...
                                            outlined
                                            v-model="
                                                attributeData.additionalInformation
                                            "
                                            :label="
                                                $t(
                                                    'form.variableForm.additionalInformation'
                                                )
                                            "
                                            outline
                                        />
                                    ...
                                    <v-col cols="12">
                                        <v-checkbox
                                            ...
                                            :label="
                                                $t(
                                                    'form.variableForm.forAnonymise'
                                                )
                                            "
                                        />
                                    </v-col>
                            ...
                            <v-expansion-panel-content>
                                <v-row v-if="attribute && attribute.isInGroup">
                                    <v-alert
                                        ...
                                        width="100%"
                                    >
                                        This attribute is used in group. Can't
                                        be used as multiple value.
                                    </v-alert>
                                </v-row>
                                <v-row v-else>
                                    <v-col cols="12">
                                    ...
                                    >
                                        <v-switch
                                            ...
                                            outlined
                                            v-model="
                                                attributeData.settings.isInline
                                            "
                                            :label="
                                                $t('form.variableForm.isInline')
                                            "
                                        ></v-switch>
                                    </v-col>
                                    <v-col
                                        cols="12"
                                        v-if="attributeData.settings.isInline"
                                    >
                                        <v-select
                                            persistent-hint
                                            ...
                                            :hint="
                                                $t(
                                                    'form.variableForm.multiRenderTypeHint'
                                                )
                                            "
                                            hide-details
                                            dense
                                            ...
                                            :label="
                                                $t(
                                                    'form.variableForm.multiRenderType'
                                                )
                                            "
                                        />
                                    </v-col>
                ...
                >
                    <v-expansion-panels>
                        <v-expansion-panel>
                            ...
                            <v-expansion-panel-content>
                                <v-expansion-panels
                                    v-for="attribute in attributeData.settings
                                        .attributes"
                                    :key="attribute.id"
                                >
                                    <v-expansion-panel>
            ...
            axios
                ...
                .then((res) => {
                    ...
                    const attributeData = res.data.find(
                        (x) =>
                            x.attributeType === this.attributeData.attributeType
                    )
