...
class AttributeValidator {
    ...
    initialize(attribute) {
        if (!attribute) {
            throw new Error(
                'Attribute validator initialized with null attribute'
            )
        }
    ...
    validateLengthMin() {
        if (this.settings.lengthMin) {
            ...
            if (
                ...
                parseInt(this.settings.lengthMin)
            ) {
                const validationError = AttributeValidatorHelper.isArray(
                    this.attribute
                )
        ...
        if (this.settings.lengthMax) {
            ...
            if (
                (AttributeValidatorHelper.isArray(this.attribute)
                    ? this.value.length
                    : String(this.value).length) >
                parseInt(this.settings.lengthMax)
            ) {
                const validationError = AttributeValidatorHelper.isArray(
                    this.attribute
                )
