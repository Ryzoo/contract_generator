        ...
        },
        {
            ...
            children: [
                ...
                },
                {
                    ...
                    meta: {
                        title: window.$t(
                            'pageMeta.panel.contract.create.title'
                        ),
                        access: [Permissions.MANAGE_CONTRACTS],
                    },
                },
                ...
                },
                {
                    ...
                    meta: {
                        title: window.$t(
                            'pageMeta.panel.contract.builder.title'
                        ),
                        access: [Permissions.MANAGE_CONTRACTS],
                    },
                },
                ...
                },
                {
                    ...
                    meta: {
                        title: window.$t(
                            'pageMeta.panel.category.create.title'
                        ),
                        access: [Permissions.MANAGE_ROLES],
                    },
                },
                ...
                },
                {
                    ...
                    meta: {
                        title: window.$t(
                            'pageMeta.panel.accounts.create.title'
                        ),
                        access: [Permissions.MANAGE_USERS],
                    },
                },
                ...
                },
                {
                    ...
                    meta: {
                        title: window.$t(
                            'pageMeta.panel.accounts.preview.title'
                        ),
                    },
                },
                {
        ...
        },
        {
            ...
            children: [
                ...
                },
                {
                    ...
                    meta: {
                        title: window.$t(
                            'pageMeta.auth.sendResetPasswordToken.title'
                        ),
                        noRequireAuthorization: true,
                    },
                },
                ...
                .then((returned) => {
                    if (returned) {
                        if (
                            to.meta &&
                            to.meta.access &&
                            !to.meta.access.every((z) =>
                                auth.checkPermission(z)
                            )
                        ) {
                            next({
                                path: '/no-access',
